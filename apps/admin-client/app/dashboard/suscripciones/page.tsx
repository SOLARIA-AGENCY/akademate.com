              ...
              {plans.map((plan) => (
                <div
                  ...
                  className={`relative rounded-xl border ${
                    plan.isPopular
                      ? 'bg-gradient-to-b from-indigo-500/10 to-muted/20 border-indigo-500'
                      : 'bg-muted/30 '
                  }`}
                >
                  {plan.isPopular && (
                    <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
                      <span className="px-3 py-1 bg-indigo-500 text-foreground text-xs font-medium rounded-full">
                        Más Popular
                      </span>
                    </div>
                  )}
                  <div className="p-6">
                    ...
                    <div className="mt-6 space-y-3">
                      <div className="flex items-center gap-2 text-sm">
                        ...
                        <span className="text-foreground">{formatFeatureValue(plan.features.users)} usuarios</span>
                      </div>
                      <div className="flex items-center gap-2 text-sm">
                        <svg className="w-4 h-4 text-green-400" fill="currentColor" viewBox="0 0 20 20">
                          <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                        </svg>
                        <span className="text-foreground">{formatFeatureValue(plan.features.sites)} sedes</span>
                      </div>
                      <div className="flex items-center gap-2 text-sm">
                        <svg className="w-4 h-4 text-green-400" fill="currentColor" viewBox="0 0 20 20">
                          <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                        </svg>
                        <span className="text-foreground">{plan.features.storage} almacenamiento</span>
                      </div>
                      <div className="flex items-center gap-2 text-sm">
                        <svg className="w-4 h-4 text-green-400" fill="currentColor" viewBox="0 0 20 20">
                          <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                        </svg>
                        <span className="text-foreground">{formatFeatureValue(plan.features.courses)} cursos</span>
                      </div>
                      <div className="flex items-center gap-2 text-sm">
                        <svg className={`w-4 h-4 ${plan.features.analytics ? 'text-green-400' : 'text-muted-foreground'}`} fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <span className={plan.features.analytics ? 'text-foreground' : 'text-muted-foreground'}>Analíticas avanzadas</span>
                      </div>
                      <div className="flex items-center gap-2 text-sm">
                        <svg className={`w-4 h-4 ${plan.features.api ? 'text-green-400' : 'text-muted-foreground'}`} fill="currentColor" viewBox="0 0 20 20">
                          {plan.features.api ? (
                            <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                          ) : (
                            <path fillRule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clipRule="evenodd" />
                        ...
                        <span className={plan.features.api ? 'text-foreground' : 'text-muted-foreground'}>Acceso API</span>
                      </div>
                      <div className="flex items-center gap-2 text-sm">
                        <svg className={`w-4 h-4 ${plan.features.sso ? 'text-green-400' : 'text-muted-foreground'}`} fill="currentColor" viewBox="0 0 20 20">
                          {plan.features.sso ? (
                            <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                          ) : (
                            <path fillRule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clipRule="evenodd" />
                        ...
                        <span className={plan.features.sso ? 'text-foreground' : 'text-muted-foreground'}>SSO / SAML</span>
                      </div>
                      {renderAddons(plan)}
                    </div>
                    ...
                    <button
                      ...
                      className="w-full mt-6 px-4 py-2 bg-muted/50 text-foreground rounded-lg hover:bg-muted transition-colors"
                    >
                      Editar Plan
                    </button>
                  </div>
              ...
              <tbody className="divide-y divide-muted/20">
                {subscriptions.map((sub) => (
                  <tr key={sub.id} className="hover:bg-muted/30 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <span className={`font-medium ${sub.amount > 0 ? 'text-foreground' : 'text-muted-foreground'}`}>
                        {sub.amount > 0 ? `€${sub.amount}/mes` : 'Trial'}
                      </span>
                    </td>
                    <td className="px-6 py-4">
                      <div className="text-sm">
                        <p className="text-foreground">{formatDate(sub.currentPeriodStart)}</p>
                        <p className="text-muted-foreground">→ {formatDate(sub.currentPeriodEnd)}</p>
                      </div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-2">
                        <button className="px-3 py-1 text-sm text-muted-foreground hover:text-foreground hover:bg-muted/50 rounded transition-colors">
                          Ver
                        </button>
                        <button className="px-3 py-1 text-sm text-indigo-400 hover:text-indigo-300 hover:bg-muted/50 rounded transition-colors">
                          Cambiar Plan
                        </button>
                      </div>
                    </td>
        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
          <div className="glass-panel rounded-xl border border-muted/30 w-full max-w-lg mx-4">
            ...
            <div className="p-6 space-y-4">
              <div>
                <label className="block text-sm font-medium text-foreground mb-1">Precio Mensual (€)</label>
                <input
                  type="number"
              ...
              <div>
                <label className="block text-sm font-medium text-foreground mb-1">Límite de Usuarios</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-foreground mb-1">Límite de Sedes</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-foreground mb-1">Almacenamiento</label>
                <input
                  type="text"
            ...
            <div className="p-6 border-t border-muted/30 flex justify-end gap-3">
              <button
              ...
              <button className="px-4 py-2 bg-indigo-600 text-foreground rounded-lg hover:bg-indigo-700 transition-colors">
                Guardar Cambios
              </button>
            </div>
          </div>
