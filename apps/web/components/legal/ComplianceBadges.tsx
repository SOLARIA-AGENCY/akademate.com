  ...
  return (
    <div className="flex flex-col items-center gap-4 sm:items-end">
      <p className="text-sm font-semibold text-white">
        Privacy and responsible AI, built into the conversation.
      </p>
      <div
        className="flex flex-nowrap items-center gap-5"
        aria-label="Privacy and responsible AI information"
      >
        {marks.map((mark) => (
          <Link
            key={mark.href}
      ...
      <p className="text-xs text-blue-100/45">
        Explore how Akademate approaches privacy, transparency and human oversight.
      </p>
    </div>
  )
}
