...
const marks = [
  ...
  },
  {
    ...
    width: 846,
    height: 215,
    className: 'h-9 w-auto max-w-[10rem] brightness-0 invert',
  },
] as const
    ...
    >
      {marks.map((mark) => (
        <Link
          ...
          className="inline-flex min-h-11 items-center rounded-lg border border-white/10 bg-white/[.06] px-3 opacity-80 transition hover:bg-white/10 hover:opacity-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-300"
        >
          <Image
            src={mark.src}
