    ...
    <footer className="bg-[#050f24] text-white">
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8 lg:py-20">
        ...
        <div className="mt-14 grid gap-8 border-t border-white/10 pt-9 lg:grid-cols-[1fr_auto] lg:items-end">
          <div><p className="max-w-xl text-2xl font-semibold tracking-tight">Run a better academy. Create a better experience for everyone in it.</p><p className="mt-3 text-sm text-blue-100/50">Akademate brings growth, operations, learning and finance into one connected rhythm.</p></div><ComplianceBadges />
        </div>
        <div>
...
function XMark() {
  return <svg viewBox="0 0 24 24" className="h-4 w-4" fill="currentColor" aria-hidden="true"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24h-6.657l-5.214-6.817-5.965 6.817H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231 5.45-6.231Zm-1.161 17.52h1.833L7.084 4.126H5.117L17.083 19.77Z" /></svg>
}

function InstagramMark() {
  return <svg viewBox="0 0 24 24" className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="5" /><circle cx="12" cy="12" r="4" /><circle cx="17.5" cy="6.5" r="1" fill="currentColor" stroke="none" /></svg>
}

function FacebookMark() {
  return <svg viewBox="0 0 24 24" className="h-5 w-5" fill="currentColor" aria-hidden="true"><path d="M13.5 21v-8h2.75l.41-3H13.5V8.08c0-.87.24-1.46 1.58-1.46h1.69V3.94a22.8 22.8 0 0 0-2.46-.13c-2.43 0-4.1 1.48-4.1 4.21V10H7.46v3h2.75v8h3.29Z" /></svg>
}
