    ...
    >
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-8 lg:grid-cols-[.75fr_1.25fr] lg:items-end">
          <div>
            <p className="text-sm font-semibold text-blue-700">The academy command centre</p>
            <h2 className="mt-5 text-4xl font-semibold tracking-[-0.045em] sm:text-5xl">
              Run your academy with clarity.
            </h2>
          </div>
          <p className="max-w-2xl text-lg leading-8 text-slate-600">
            Coordinate admissions, schedules, people and finance in one live view.
          </p>
        </div>
          ...
          <div className="grid lg:grid-cols-[.38fr_.62fr]">
            <div className="relative min-h-[320px] lg:min-h-[620px]">
              ...
              <div className="absolute inset-x-0 bottom-0 p-6 text-white sm:p-8">
                <p className="text-sm font-semibold text-blue-200">Made for academy teams</p>
                <p className="mt-3 max-w-sm text-2xl font-semibold tracking-tight">
                  Every role works from the same academy picture.
                </p>
              </div>
            </div>
            ...
            <div className="bg-[#f7f9fc] p-4 sm:p-7 lg:p-9">
              <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm sm:p-6">
                <div className="flex flex-wrap items-center justify-between gap-4">
                  <div>
                    <p className="text-xs font-semibold text-blue-700">MONDAY · LIVE OPERATION</p>
                    <h3 className="mt-2 text-2xl font-semibold tracking-tight">Academy overview</h3>
                  </div>
                  <div className="flex items-center gap-2 rounded-full bg-emerald-50 px-3 py-2 text-xs font-semibold text-emerald-700">
                    <CheckCircle2 className="h-4 w-4" aria-hidden="true" /> All sites connected
                  </div>
                </div>
                ...
                <div className="mt-4 grid gap-4 xl:grid-cols-[1.15fr_.85fr]">
                  <div className="rounded-xl border border-slate-200 p-4 sm:p-5">
                    <div className="flex items-center justify-between">
                      <h4 className="font-semibold">Today across the academy</h4>
                      <span className="text-xs font-semibold text-blue-700">View calendar</span>
                    </div>
                  ...
                  <div className="rounded-xl bg-[#071633] p-5 text-white">
                    <p className="text-sm font-semibold text-blue-200">Admissions pulse</p>
                    <p className="mt-5 text-4xl font-semibold">42</p>
                    <p className="mt-1 text-sm text-blue-100/70">active applications</p>
