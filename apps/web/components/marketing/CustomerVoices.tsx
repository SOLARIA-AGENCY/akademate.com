      ...
      <div className="mx-auto max-w-7xl">
        <div className="max-w-4xl">
          <p className="text-sm font-semibold text-blue-700">
            {t('Public reviews, part of the experience')}
          </p>
          <h2
            id="customer-voices-title"
            className="mt-5 text-4xl font-semibold tracking-[-0.045em] sm:text-6xl"
          >
            {t('Let every academy voice be heard.')}
          </h2>
          <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-600">
            {t('Bring verified learner feedback into every course journey.')}
          </p>
        </div>
          ...
          {reviews.map((review, index) => (
            ...
            >
              ...
              <p className="mt-1 text-xs text-slate-500">
                {t('Public learner review presented by CEP Formación')}
              </p>
            </article>
          ))}
        </div>
