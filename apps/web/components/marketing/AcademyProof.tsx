...
export function AcademyProof() {
  ...
  return (
    <section
      aria-labelledby="academy-proof-title"
      className="border-y border-white/10 bg-[#071633] text-white"
    >
      <div className="mx-auto grid max-w-7xl gap-8 px-4 py-10 sm:px-6 lg:grid-cols-[.72fr_1.5fr] lg:items-center lg:px-8">
        <div className="flex items-center gap-5 border-white/15 lg:border-r lg:pr-10">
          <div className="flex h-16 w-28 shrink-0 items-center justify-center rounded-xl bg-white px-3">
            <Image
              src="/logos/customers/cep-formacion.png"
              alt="CEP Formación"
              width={220}
              height={65}
          ...
          <div>
            ...
            <h2 id="academy-proof-title" className="mt-2 text-lg font-semibold">
              CEP Formación
            </h2>
          </div>
        </div>
        ...
        <div className="min-w-0 overflow-hidden">
          <p className="mb-4 text-xs font-semibold text-blue-200">
            {t('Built for modern academy models')}
          </p>
