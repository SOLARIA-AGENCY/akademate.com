...
export const verticals = [
  ...
  },
  {
    ...
    description: 'Cohorts, projects, mentors and job-ready portfolios.',
    ...
    capabilities: ['Cohorts', 'Projects', 'Mentors'],
  },
  {
...
export const solutionDetails = {
  ...
  'driving-schools': {
    ...
    outcomes: [
      ...
      'Keep cars, instructors and slots aligned',
      'Track theory, practice and exam dates',
      'Collect fees without chasing spreadsheets',
    ],
    workflow: ['Book a lesson', 'Assign a car', 'Track progress', 'Pass the exam'],
    modules: [
      'Lesson booking',
      'Vehicle and instructor diary',
      'Exam and progress records',
      'Fees and receipts',
    ],
  },
  'coding-academies': {
    ...
    outcomes: [
      ...
      'Keep project work and feedback in one campus',
      'Give mentors a clear view of each learner',
      'Show hiring-ready work without extra tools',
    ],
    workflow: ['Apply', 'Join a cohort', 'Build projects', 'Get hired'],
