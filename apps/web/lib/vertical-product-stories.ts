    ...
    moments: [
      {
        id: 'lessons',
        label: 'Lessons',
        title: 'Fill the lesson diary.',
        text: 'Turn enquiries into confirmed slots with the right instructor.',
        metric: '38',
        metricLabel: 'lessons booked this week',
        fields: [
          { label: 'Lesson type', options: ['First lesson', 'Motorway', 'Parking'] },
          { label: 'Schedule', options: ['Tue 10:00', 'Thu 18:30', 'Sat 09:00'] },
          { label: 'Instructor', options: ['Marta Ruiz', 'Owen Blake'] },
        ],
        activity: ['Two new enquiries', 'Saturday morning full', 'Waitlist offered'],
      },
      {
        id: 'vehicles',
        label: 'Vehicles',
        title: 'Keep cars and slots aligned.',
        text: 'Assign dual-control cars without double-booking instructors.',
        metric: '6',
        metricLabel: 'cars available today',
        fields: [
          { label: 'Vehicle', options: ['Compact A', 'Compact B', 'Automatic'] },
          { label: 'Status', options: ['Ready', 'In lesson', 'Service'] },
          { label: 'Campus', options: ['City centre', 'North depot'] },
        ],
        activity: ['Automatic reserved', 'Service booked Friday', 'Fuel logged'],
      },
      {
        id: 'exams',
        label: 'Exams',
        title: 'Track theory and practical exams.',
        text: 'See readiness, exam dates and pass rates in one learner record.',
        metric: '72%',
        metricLabel: 'first-time pass rate',
        fields: [
          { label: 'Stage', options: ['Theory', 'Practical', 'Retake'] },
          { label: 'Readiness', options: ['Ready', 'Needs hours', 'Mock booked'] },
          { label: 'Exam centre', options: ['Local centre', 'North centre'] },
        ],
        activity: ['Mock test booked', 'Theory passed', 'Practical date held'],
      },
      {
        id: 'fees',
        label: 'Payments',
        title: 'Collect packs and extra hours.',
        text: 'Sell lesson packs, extras and exam fees without chasing cash.',
        metric: '€890',
        metricLabel: 'pack revenue today',
        fields: [
          { label: 'Product', options: ['10-hour pack', 'Extra hour', 'Exam fee'] },
          { label: 'Billing', options: ['Pay now', 'Instalments'] },
          { label: 'Method', options: ['Stripe card', 'SEPA debit'] },
        ],
        activity: ['Pack started', 'Two extras billed', 'Receipt sent'],
        connectors: ['stripe', 'sepa'],
      },
    ],
  },
    ...
    moments: [
      {
        id: 'cohort',
        label: 'Cohort',
        title: 'Fill the next cohort.',
        text: 'Move applicants from interest to a confirmed start date.',
        metric: '24',
        metricLabel: 'places in October cohort',
        fields: [
          { label: 'Programme', options: ['Full-stack', 'Data', 'UX engineering'] },
          { label: 'Start', options: ['6 October', '12 January'] },
          { label: 'Format', options: ['Full-time', 'Part-time', 'Online'] },
        ],
        activity: ['12 ready to enrol', '4 awaiting deposit', 'Interview slots open'],
      },
      {
        id: 'projects',
        label: 'Projects',
        title: 'Keep project work visible.',
        text: 'Teachers see submissions, reviews and blockers in one campus.',
        metric: '18',
        metricLabel: 'projects in review',
        fields: [
          { label: 'Sprint', options: ['Auth API', 'Storefront', 'Capstone'] },
          { label: 'Status', options: ['In progress', 'Review', 'Shipped'] },
          { label: 'Repo', options: ['Team A', 'Team B'] },
        ],
        activity: ['Capstone brief published', 'Two reviews due', 'Demo Thursday'],
      },
      {
        id: 'mentors',
        label: 'Mentors',
        title: 'Give mentors a clear view.',
        text: 'Assign mentors, office hours and feedback without extra chat tools.',
        metric: '9',
        metricLabel: 'active mentors',
        fields: [
          { label: 'Mentor', options: ['Leah Okonkwo', 'Pavel Novak'] },
          { label: 'Focus', options: ['Backend', 'Career', 'Pairing'] },
          { label: 'Cadence', options: ['Weekly 1:1', 'Drop-in lab'] },
        ],
        activity: ['Office hours posted', 'Career session booked', 'Feedback returned'],
      },
      {
        id: 'placement',
        label: 'Progress',
        title: 'Show hiring-ready work.',
        text: 'Track portfolios, interviews and offers next to the learner record.',
        metric: '81%',
        metricLabel: 'graduates placed in 90 days',
        fields: [
          { label: 'Stage', options: ['Portfolio', 'Interview', 'Offer'] },
          { label: 'Partner', options: ['Studio North', 'Product Lab'] },
          { label: 'Outcome', options: ['Interviewing', 'Offer', 'Hired'] },
        ],
        activity: ['Portfolio live', 'Two interviews this week', 'Offer accepted'],
      },
    ],
  },
}
