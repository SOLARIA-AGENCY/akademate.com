...
export default function PrivacyPage() { return <LegalPage title="Privacy policy" description="Information about personal data associated with the Akademate corporate website and service." sections={[
  ...
  { title: 'Rights and contact', content: <p>Requests about data managed by an academy should normally be directed to that organisation. Until a dedicated privacy channel is validated, enquiries for SOLARIA may be sent to info@akademate.com.</p> },
]} /> }
