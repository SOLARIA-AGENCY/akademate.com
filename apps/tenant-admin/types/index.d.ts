...
export type CourseType = 'teleformacion' | 'ocupados' | 'desempleados' | 'privados' | 'ciclo-medio' | 'ciclo-superior';
...
export type EntidadFinanciadoraKey = 'fundae' | 'sepe' | 'ministerio_trabajo' | 'ministerio_educacion' | 'junta_andalucia' | 'junta_madrid' | 'junta_catalunya' | 'fse' | 'next_generation' | 'camara_comercio' | 'empresa_privada' | 'otro';
...
export type ModuloSistema = 'cursos' | 'programacion' | 'ciclos' | 'sedes' | 'aulas' | 'profesores' | 'administrativos' | 'alumnos' | 'leads' | 'matriculas' | 'campanas' | 'creatividades' | 'contenido' | 'analiticas' | 'administracion';
