 ...
 */
export function getEntidadInfo(key) {
 ...
 */
export function getEntidadesDisponibles(excluidas) {
    const excluded = excluidas || [];
    return getAllEntidades().filter((entidad) => !excluded.includes(entidad.key));
}
//# sourceMappingURL=entidadesFinanciadoras.js.map