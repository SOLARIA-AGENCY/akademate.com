...
export function DeleteCourseDialog({ isOpen, onClose, onConfirm, nombreCurso, tieneConvocatorias, numeroConvocatorias, isDeleting, }) {
      ...
      <DialogContent className="max-w-md">
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-3">
            ...
            {tieneConvocatorias && (<Alert className="border-amber-500 bg-amber-50 dark:bg-amber-950/30">
          ...
          <div className="space-y-2">
            ...
            <Input id="confirm-text" value={confirmText} onChange={(e) => setConfirmText(e.target.value.toUpperCase())} placeholder={`Escribe "${CONFIRM_PHRASE}"`} disabled={isDeleting} className={cn('font-mono uppercase', canConfirm && 'border-green-500 focus-visible:ring-green-500')} autoComplete="off"/>
          </div>
        </div>
        ...
        <DialogFooter>
          ...
          <Button variant="destructive" onClick={onConfirm} disabled={!canConfirm || isDeleting} className="gap-2">
            {isDeleting ? (<>
...
//# sourceMappingURL=DeleteCourseDialog.js.map