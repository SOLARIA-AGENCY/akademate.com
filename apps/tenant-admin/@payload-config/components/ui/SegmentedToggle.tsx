      ...
      {options.map((option) => {
        ...
        return (
          <ToggleGroupItem
            ...
            className={cn(
              'h-8 border-0 px-3 text-xs font-semibold transition-all focus-visible:ring-primary data-[state=on]:bg-primary data-[state=on]:text-primary-foreground data-[state=on]:hover:bg-primary/90',
              value === option.value
