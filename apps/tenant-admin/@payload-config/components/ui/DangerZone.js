...
export function DangerZone({ cursoId, nombreCurso, tieneConvocatorias, numeroConvocatorias, }) {
    ...
    return (<>
      ...
      <DeleteCourseDialog isOpen={isDialogOpen} onClose={() => setIsDialogOpen(false)} onConfirm={handleEliminar} nombreCurso={nombreCurso} tieneConvocatorias={tieneConvocatorias} numeroConvocatorias={numeroConvocatorias} isDeleting={isDeleting}/>
    </>);
}
