...
import { DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuLabel, DropdownMenuSeparator, DropdownMenuTrigger, } from '@payload-config/components/ui/dropdown-menu';
...
export function StaffCard({ id, fullName, position, contractType, employmentStatus, photo, email, phone, bio, assignedCampuses, onView, onEdit, onDelete, }) {
    ...
    return (<Card className="overflow-hidden hover:shadow-lg transition-shadow cursor-pointer group">
      <div onClick={() => onView(id)}>
        <CardContent className="p-6">
          ...
          <div className="space-y-2 mb-4">
            ...
            {phone && (<div className="flex items-center gap-2 text-sm text-muted-foreground">
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-1 flex-wrap">
              {assignedCampuses.length === 0 ? (<Badge variant="outline" className="text-xs">
                  Sin sedes asignadas
                </Badge>) : (assignedCampuses.map((campus) => (<Badge key={campus.id} variant="secondary" className="text-xs">
...
//# sourceMappingURL=StaffCard.js.map