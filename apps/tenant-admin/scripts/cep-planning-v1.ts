...
const STAFF_SEED_SOURCE: Array<Omit<CepStaffSeed, 'first_name' | 'last_name' | 'data_quality_status' | 'source'>> = [
  ...
  { fullName: 'Nerea Illesca', staff_type: 'profesor', position: 'Docente', specialties: ['Clínicas estéticas'], aliases: ['Nerea'], detectedCourses: ['Auxiliar en Clínicas Estéticas'], assignedCampusSlugs: ['sede-santa-cruz'] },
