...
export async function up({ db }: MigrateUpArgs): Promise<void> {
  ...
  await db.execute(sql`
    ALTER TABLE "course_runs"
      ...
      ADD COLUMN "offer_price_amount" numeric(12, 2),
      ...
      ADD CONSTRAINT "course_runs_payment_mode_check"
        CHECK (
          (
            ...
            AND "offer_price_amount" IS NOT NULL
            AND "offer_price_amount" > 0
            AND (
              ...
              OR (
                ...
                AND "deposit_amount" < "offer_price_amount"
              )
            )
          )
          OR (
...
export async function down({ db }: MigrateDownArgs): Promise<void> {
  ...
  await db.execute(sql`
    ...
    BEGIN
      IF EXISTS (
        ...
        WHERE "publication_access" <> 'private'
          ...
          OR "offer_price_amount" IS NOT NULL
    ...
    ALTER TABLE "course_runs"
      ...
      DROP COLUMN "offer_price_amount",
