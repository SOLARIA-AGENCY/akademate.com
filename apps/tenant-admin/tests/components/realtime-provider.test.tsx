...
vi.mock('@akademate/realtime/context', () => ({
  SocketProvider: ({ children }: { children: ReactNode }) => (
    <div data-testid="socket-provider" data-oid="4748dc6">
      {children}
    </div>
  ),
}))
...
describe('RealtimeProvider', () => {
  ...
  it('does not mount socket provider when socket endpoint is unavailable', async () => {
    ...
    render(
      <RealtimeProvider data-oid="qm3c9x.">
        <div data-oid="6m7usdb">child content</div>
      </RealtimeProvider>
    )
  ...
  it('mounts socket provider when socket handshake endpoint is available', async () => {
    ...
    render(
      <RealtimeProvider data-oid="hyr462u">
        <div data-oid=".1kdw8x">child content</div>
      </RealtimeProvider>
    )
