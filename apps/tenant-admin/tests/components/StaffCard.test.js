...
describe('StaffCard Component', () => {
    describe('Basic rendering', () => {
        it('should render staff name', () => {
            ...
            render(<StaffCard {...mockStaffProfesor} onView={mockOnView} onEdit={mockOnEdit} onDelete={mockOnDelete}/>);
    ...
    describe('Avatar rendering', () => {
        ...
        it('should show fallback initials', () => {
            ...
            const mockOnEdit = vi.fn();
            const mockOnDelete = vi.fn();
            const { container } = render(<StaffCard {...mockStaffProfesor} onView={mockOnView} onEdit={mockOnEdit} onDelete={mockOnDelete}/>);
    ...
    describe('Badges rendering', () => {
        ...
        it('should render part-time contract correctly', () => {
            ...
            render(<StaffCard {...partTimeStaff} onView={mockOnView} onEdit={mockOnEdit} onDelete={mockOnDelete}/>);
    ...
    describe('Campus assignments', () => {
        ...
        it('should show single campus for administrative staff', () => {
            ...
            const mockOnEdit = vi.fn();
            const mockOnDelete = vi.fn();
            render(<StaffCard {...mockStaffAdmin} onView={mockOnView} onEdit={mockOnEdit} onDelete={mockOnDelete}/>);
            expect(screen.getByText('CEP Norte')).toBeInTheDocument();
        ...
        it('should show message when no campuses assigned', () => {
            ...
            render(<StaffCard {...noCampusStaff} onView={mockOnView} onEdit={mockOnEdit} onDelete={mockOnDelete}/>);
    ...
    describe('Bio display', () => {
        ...
        it('should not render bio section when not provided', () => {
            ...
            const { container } = render(<StaffCard {...noBioStaff} onView={mockOnView} onEdit={mockOnEdit} onDelete={mockOnDelete}/>);
    ...
    describe('Different employment statuses', () => {
        it('should render temporary leave status', () => {
            ...
            render(<StaffCard {...tempLeaveStaff} onView={mockOnView} onEdit={mockOnEdit} onDelete={mockOnDelete}/>);
        ...
        it('should render inactive status', () => {
            ...
            render(<StaffCard {...inactiveStaff} onView={mockOnView} onEdit={mockOnEdit} onDelete={mockOnDelete}/>);
...
//# sourceMappingURL=StaffCard.test.js.map