 ...
 */
export type ValidationFunction<T = unknown> = (value: T, context?: {
    operation?: string;
    originalDoc?: unknown;
    [key: string]: unknown;
 ...
 */
export declare const validator: <T>(fn: ValidationFunction<T>) => never;
//# sourceMappingURL=payload-extended.d.ts.map