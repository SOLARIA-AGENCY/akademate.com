 ...
 */
export const getUserTenantId = (user) => {
    if (!user)
        return null;
 ...
 */
export const tenantReadAccess = ({ req }) => {
    if (!req.user)
        return false;
 ...
 */
export const tenantCreateAccess = ({ req }) => {
    if (!req.user)
        return false;
 ...
 */
export const tenantUpdateAccess = ({ req }) => {
    if (!req.user)
        return false;
 ...
 */
export const tenantDeleteAccess = ({ req }) => {
    if (!req.user)
        return false;
 ...
 */
export const tenantFieldAccess = ({ req }) => {
    if (!req.user)
        return false;
 ...
 */
export const autoAssignTenant = ({ req, data }) => {
