    ...
    fields: [
         ...
         */
        {
            ...
            validate: (val) => {
                ...
                if (val.length > 500)
                    return 'Slug must be 500 characters or less';
                if (!/^[a-z0-9-]+$/.test(val)) {
         ...
         */
        {
            ...
            validate: (val) => {
                ...
                if (val.length > 500)
                    return 'Course name must be 500 characters or less';
                return true;
            },
        },
        /**
         ...
         */
        {
            ...
            admin: {
                ...
                step: 1,
                condition: (data) => !data.base_price || data.base_price === 0,
            },
            validate: (val, { data }) => {
                ...
                if (val === undefined || val === null)
                    return true;
                if (val < 0 || val > 100)
                    return 'Subsidy percentage must be between 0 and 100';
                return true;
            },
        },
        /**
         ...
         */
        {
            ...
            validate: (val) => {
                ...
                if (val.length > 300)
                    return 'Meta title must be 300 characters or less';
                return true;
            },
        },
        /**
         ...
         */
        {
            ...
            validate: (val) => {
                if (!val)
                    return true; // Optional
                if (val.length > 500)
                    return 'Meta description must be 500 characters or less';
                return true;
            },
        },
        /**
