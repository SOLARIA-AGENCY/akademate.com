...
export const roleSchema = z.enum(['admin', 'gestor', 'marketing', 'asesor', 'lectura'], {
    ...
    invalid_type_error: 'Role must be one of: admin, gestor, marketing, asesor, lectura',
});
/**
...
export const phoneSchema = z
    .string()
    .regex(/^\+34\s\d{3}\s\d{3}\s\d{3}$/, 'Phone must be in format: +34 XXX XXX XXX (e.g., +34 123 456 789)')
    .optional();
/**
