import { canCreateCourseRun, canReadCourseRuns, canUpdateCourseRun, canDeleteCourseRun, } from './access';
import { validateCourseRunDates, validateCourseRunRelationships, trackCourseRunCreator, validateEnrollmentCapacity, generateCourseRunCode, captureCompletionSnapshot, } from './hooks';
...
export const CourseRuns = {
    ...
    fields: [
        ...
        },
        {
            ...
            validate: (val) => {
                if (val === undefined || val === null)
                    return 'Min students is required';
                if (val < 1)
                    return 'Min students must be at least 1';
                return true;
            },
        },
        {
        ...
        // ============================================================================
        {
            ...
            validate: (val) => {
                if (val === undefined || val === null)
                    return true; // Optional field
                if (val < 0)
                    return 'Price override cannot be negative';
                return true;
            },
        },
        {
...
//# sourceMappingURL=CourseRuns.js.map