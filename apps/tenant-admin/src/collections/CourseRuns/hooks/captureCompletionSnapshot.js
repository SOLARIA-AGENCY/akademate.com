 ...
 */
export const captureCompletionSnapshot = async ({ doc, req, previousDoc, operation, }) => {
    ...
    try {
        ...
        console.log(`[COURSE_RUN] Captured completion snapshot for ${doc.codigo}: ` +
...
//# sourceMappingURL=captureCompletionSnapshot.js.map