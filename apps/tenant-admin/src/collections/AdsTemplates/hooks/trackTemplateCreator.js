...
export const trackTemplateCreator = ({ req, operation, value: _value, originalDoc }) => {
    ...
    if (operation === 'update') {
        ...
        if (!originalDoc?.created_by) {
            ...
            throw new Error('Cannot update template: created_by field is missing or corrupted. Contact system administrator.');
        }
...
//# sourceMappingURL=trackTemplateCreator.js.map