import { canCreateAdsTemplate, canReadAdsTemplates, canUpdateAdsTemplate, canDeleteAdsTemplate, } from './access';
import { trackTemplateCreator, setArchivedTimestamp, validateTemplateContent, validateAssetURLs, validateTagsHook, } from './hooks';
import { VALID_TEMPLATE_TYPES, VALID_STATUSES, VALID_TONES, VALID_LANGUAGES, validateTemplateName, validateStatusWorkflow, } from './AdsTemplates.validation';
/**
...
//# sourceMappingURL=AdsTemplates.js.map