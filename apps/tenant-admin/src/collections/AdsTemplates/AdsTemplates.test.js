...
describe('AdsTemplates Collection - TDD Test Suite', () => {
    ...
    let gestorUser;
    let marketingUser;
    let marketing2User; // Second marketing user for ownership tests
    let asesorUser;
    let lecturaUser;
    let testCampaign;
    // Valid template data
    ...
    describe('Business Logic Tests', () => {
        ...
        describe('Soft Delete Behavior', () => {
            ...
            it('should filter out soft-deleted templates by default', async () => {
                ...
                const found = result.docs.find((doc) => doc.id === template.id);
...
//# sourceMappingURL=AdsTemplates.test.js.map