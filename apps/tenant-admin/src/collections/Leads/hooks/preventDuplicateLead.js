 ...
 */
export const preventDuplicateLead = async ({ data, req, operation }) => {
    ...
    try {
        ...
        if (existingLeads.docs.length > 0) {
            ...
            throw new Error('You have already submitted a request for this course in the last 24 hours. ' +
...
//# sourceMappingURL=preventDuplicateLead.js.map