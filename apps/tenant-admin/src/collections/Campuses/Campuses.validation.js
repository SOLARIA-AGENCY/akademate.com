...
export const campusSchema = z.object({
    ...
    phone: z
        .string()
        .regex(SPANISH_PHONE_REGEX, 'Phone must be in format: +34 XXX XXX XXX (e.g., "+34 912 345 678")')
        .optional()
        .nullable()
 ...
 */
export function validateCampus(data) {
 ...
 * @returns Validation result with parsed data or errors
 */
export function validateCampusCreate(data) {
 ...
 * @returns Validation result with parsed data or errors
 */
export function validateCampusUpdate(data) {
 ...
 */
export function isValidSpanishPostalCode(postalCode) {
...
//# sourceMappingURL=Campuses.validation.js.map