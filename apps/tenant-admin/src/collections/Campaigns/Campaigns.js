import { canCreateCampaign, canReadCampaigns, canUpdateCampaign, canDeleteCampaign, } from './access';
import { trackCampaignCreator, validateCampaignDates, validateCampaignTargets, validateUTMParameters, calculateCampaignMetrics, } from './hooks';
import { VALID_CAMPAIGN_TYPES, VALID_CAMPAIGN_STATUSES, validateStatusWorkflow, validateBudget, } from './Campaigns.validation';
    ...
    fields: [
        ...
        // ============================================================================
        {
            ...
            validate: (val) => {
                ...
                if (val.length > 255)
                    return 'Campaign name must be 255 characters or less';
                return true;
            },
        },
        {
