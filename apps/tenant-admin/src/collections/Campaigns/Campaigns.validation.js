 ...
 */
export const TERMINAL_STATUSES = ['archived'];
// ============================================================================
// ZOD SCHEMAS
// ============================================================================
/**
 ...
 */
export function validateUTMFormat(value) {
    if (!value)
 ...
 * Returns error message if invalid, true if valid
 */
export function validateDateRange(start_date, end_date) {
 ...
 * Returns error message if invalid, true if valid
 */
export function validateStartDateNotPast(start_date, status) {
 ...
 * Returns error message if invalid, true if valid
 */
export function validateTargetRelationship(target_leads, target_enrollments) {
    // Both must be provided for validation
    if (target_leads === undefined || target_enrollments === undefined)
        return true;
 ...
 * Returns error message if invalid, true if valid
 */
export function validateStatusWorkflow(oldStatus, newStatus) {
 ...
 * Returns error message if invalid, true if valid
 */
export function validateUTMCampaignRequired(utm_source, utm_medium, utm_campaign, utm_term, utm_content) {
 ...
 * Returns error message if invalid, true if valid
 */
export function validateTargetLeads(value) {
    if (value === undefined)
        return true; // Optional
 ...
 * Returns error message if invalid, true if valid
 */
export function validateTargetEnrollments(value) {
    if (value === undefined)
        return true; // Optional
...
//# sourceMappingURL=Campaigns.validation.js.map