 ...
 * @hook beforeValidate
 */
export const validateFAQRelationships = async ({ data, req, operation, }) => {
    try {
        // Validate related_course if provided
        if (data?.related_course) {
            const courseId = typeof data.related_course === 'string' ? data.related_course : data.related_course.id;
            if (courseId) {
...
//# sourceMappingURL=validateFAQRelationships.js.map