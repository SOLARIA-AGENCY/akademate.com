 ...
 * - ca: Catalan
 */
export const VALID_LANGUAGES = ['es', 'en', 'ca'];
// ============================================================================
// ZOD SCHEMAS
// ============================================================================
/**
...
export const slugSchema = z
    ...
    .regex(/^[a-z0-9]+(?:-[a-z0-9]+)*$/, 'Slug must be lowercase, alphanumeric, and may contain hyphens only (no consecutive hyphens)');
/**
 * Excerpt Schema
 * - Required
 ...
 */
export const validateStatusWorkflow = (currentStatus, newStatus) => {
 ...
 */
export const validateRelatedCourses = (courses) => {
 ...
 */
export const normalizeSpanishCharacters = (text) => {
    const replacements = {
        á: 'a',
        à: 'a',
        ä: 'a',
 ...
 */
export const calculateEstimatedReadTime = (content) => {
    // Extract plain text
...
//# sourceMappingURL=BlogPosts.validation.js.map