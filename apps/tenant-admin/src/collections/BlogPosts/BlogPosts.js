import { canCreateBlogPost, canReadBlogPosts, canUpdateBlogPost, canDeleteBlogPost, } from './access';
import { generateSlug, trackBlogPostAuthor, trackBlogPostCreator, setPublicationTimestamp, setArchivedTimestamp, calculateReadTime, validateBlogPostRelationships, } from './hooks';
import { VALID_STATUSES, VALID_LANGUAGES, validateTitle, validateSlug, validateExcerpt, validateURL, validateTags, validateMetaTitle, validateMetaDescription, validateStatusWorkflow, validateRelatedCourses, } from './BlogPosts.validation';
/**
...
export const BlogPosts = {
    ...
    fields: [
        ...
        // ============================================================================
        {
            ...
            validate: (val, { operation, originalDoc }) => {
                if (!val)
