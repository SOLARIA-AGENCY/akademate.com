    ...
    it('should create a blog post with all optional fields', async () => {
        const post = await payload.create({
            ...
            data: {
                ...
                meta_description: 'This is a meta description optimized for SEO. It should be between 120 and 160 characters long to display properly in search results.',
...
describe('BlogPosts - Validation', () => {
    ...
    it('should accept valid meta_description (120-160 chars)', async () => {
        const validMetaDesc = 'Discover the best online courses for professional training. CEP Formación offers comprehensive programs in technology, business, and more.';
        const post = await payload.create({
            collection: 'blog_posts',
            data: {
...
describe('BlogPosts - Relationships', () => {
    ...
    it('should populate author relationship data', async () => {
        ...
        expect(fetched.author.email).toBe(marketingUser.email);
    });
    ...
    it('should populate related courses with depth query', async () => {
        ...
        expect(course.name).toBe(testCourse1.name);
    });
    ...
    it('should preserve all metadata fields on update', async () => {
        const post = await payload.create({
            ...
            data: {
                ...
                meta_description: 'SEO description that should remain unchanged when other fields are updated. This must be between 120 and 160 characters long.',
                og_image: 'https://example.com/og-image.jpg',
                tags: ['education', 'test'],
            },
            user: adminUser,
    ...
    it('should handle Spanish special characters in various fields', async () => {
        const post = await payload.create({
            ...
            data: {
                ...
                excerpt: 'José, María y Ángel estudian español. La niña comió ñoquis. Descripción con acentos y eñes para validación.',
                content: [
                    {
                        type: 'paragraph',
...
//# sourceMappingURL=BlogPosts.test.js.map