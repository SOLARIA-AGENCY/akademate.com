...
export const trackBlogPostCreator = ({ req, operation, value: _value, originalDoc }) => {
    ...
    if (operation === 'update') {
        ...
        if (!originalDoc?.created_by) {
            ...
            throw new Error('Cannot update blog post: created_by field is missing or corrupted. Contact system administrator.');
        }
...
//# sourceMappingURL=trackBlogPostCreator.js.map