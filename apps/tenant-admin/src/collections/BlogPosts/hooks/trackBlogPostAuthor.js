 ...
 */
export const trackBlogPostAuthor = ({ req, operation, value: _value, originalDoc }) => {
    ...
    if (operation === 'update') {
        ...
        if (!originalDoc?.author) {
            ...
            throw new Error('Cannot update blog post: author field is missing or corrupted. Contact system administrator.');
        }
...
//# sourceMappingURL=trackBlogPostAuthor.js.map