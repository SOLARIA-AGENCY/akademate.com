 ...
 */
export const preventAuditLogUpdates = async ({ operation, req, }) => {
    ...
    if (operation === 'update') {
        ...
        throw new Error('Audit logs are immutable and cannot be updated. This is a GDPR Article 30 compliance requirement. ' +
...
//# sourceMappingURL=preventAuditLogUpdates.js.map