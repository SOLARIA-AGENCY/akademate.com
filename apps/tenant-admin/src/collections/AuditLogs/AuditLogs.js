import { canCreateAuditLog, canReadAuditLogs, canUpdateAuditLog, canDeleteAuditLog, } from './access';
import { autoPopulateAuditMetadata, preventAuditLogUpdates, validateAuditLogData, } from './hooks';
import { VALID_ACTIONS, VALID_COLLECTION_NAMES, VALID_USER_ROLES, VALID_STATUSES, } from './schemas';
/**
...
export const AuditLogs = {
    ...
    admin: {
        ...
        group: 'System',
        description: 'Immutable audit trail for GDPR Article 30 compliance. Logs all system operations.',
    ...
    fields: [
        ...
        },
        {
            ...
            admin: {
                description: 'Snapshot of user email (preserved if user is deleted) - IMMUTABLE',
                readOnly: true, // SECURITY Layer 1 (UX): Immutable
                position: 'sidebar',
            },
        ...
        // ============================================================================
        {
            ...
            admin: {
                description: 'Client IP address (IPv4 or IPv6) - PII, IMMUTABLE, Admin/Gestor only',
                readOnly: true, // SECURITY Layer 1 (UX): Immutable
                position: 'sidebar',
            },
            // SECURITY Layer 2 (API): Field-level access control
        ...
        // ============================================================================
        {
            ...
            type: 'json',
            admin: {
                description: 'Before/after snapshots for updates (sanitized, no passwords) - IMMUTABLE',
                readOnly: true, // SECURITY Layer 1 (UX): Immutable
            },
            // SECURITY Layer 2 (API): Field-level access control
        ...
        },
        {
            ...
            type: 'json',
            admin: {
                description: 'Additional context (headers, query params, custom data) - IMMUTABLE',
                readOnly: true, // SECURITY Layer 1 (UX): Immutable
            },
            // SECURITY Layer 2 (API): Field-level access control
