...
export const ipAddressSchema = z
    .string()
    .refine((val) => ipv4Regex.test(val) || ipv6Regex.test(val), 'IP address must be valid IPv4 or IPv6 format');
// ============================================================================
 ...
 */
export const VALID_USER_ROLES = ['admin', 'gestor', 'marketing', 'asesor', 'lectura'];
 ...
 */
export const VALID_STATUSES = ['success', 'failure', 'blocked'];
 ...
 */
export const validateAuditLogData = (data) => {
 ...
 */
export const safeValidateAuditLogData = (data) => {
 ...
 */
export const sanitizeChanges = (changes) => {
