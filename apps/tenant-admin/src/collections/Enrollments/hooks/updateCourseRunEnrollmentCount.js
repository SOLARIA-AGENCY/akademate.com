 ...
 */
export const updateCourseRunEnrollmentCount = async ({ doc, previousDoc, operation, req, }) => {
    ...
    try {
        ...
        console.error(`Failed to update course run enrollment count for enrollment ${doc.id}, course_run ${doc.course_run}:`, error);
    }
    return doc;
};
//# sourceMappingURL=updateCourseRunEnrollmentCount.js.map