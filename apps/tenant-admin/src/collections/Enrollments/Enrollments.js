import { canCreateEnrollment, canReadEnrollments, canUpdateEnrollment, canDeleteEnrollment, } from './access';
import { validateEnrollmentRelationships, validateEnrollmentCapacity, trackEnrollmentCreator, captureEnrollmentTimestamps, validateFinancialData, updateCourseRunEnrollmentCount, } from './hooks';
import { VALID_ENROLLMENT_STATUSES, VALID_PAYMENT_STATUSES, VALID_FINANCIAL_AID_STATUSES, } from './Enrollments.validation';
/**
    ...
    fields: [
        ...
        },
        {
            ...
            validate: (val) => {
                ...
                if (val < 0)
                    return 'Financial aid amount cannot be negative';
                return true;
            },
            // Field-level access: Admin and Gestor only
            access: {
