...
export const Students: CollectionConfig = {
  ...
  hooks: {
     ...
     */
    beforeValidate: [
      captureStudentConsentMetadata as unknown as import('payload').CollectionBeforeValidateHook, // 1. Auto-capture GDPR consent metadata (timestamp, IP)
      validateStudentData as unknown as import('payload').CollectionBeforeValidateHook, // 2. Validate email, phone, DNI, age, emergency contact
      validateStudentRelationships as unknown as import('payload').CollectionBeforeValidateHook, // 3. Validate created_by user exists
    ],
     ...
     */
    beforeChange: [
      trackStudentCreator as unknown as import('payload').CollectionBeforeChangeHook, // 4. Auto-populate and protect created_by field
    ],
  },
