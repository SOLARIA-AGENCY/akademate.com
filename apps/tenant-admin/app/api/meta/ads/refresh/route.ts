...
export async function POST(request: NextRequest) {
  try {
    ...
    const body = normalizeAdWorkflowBody({ ...raw, strategy: raw.strategy || 'refresh_existing_ad' })
    ...
    const message = error instanceof Error ? error.message : 'No se pudo refrescar el anuncio Meta.'
