...
export default function NuevaConvocatoriaPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        const msg =
          data?.errors?.[0]?.message ?? data?.message ?? `Error ${res.status}`
        throw new Error(msg)
      }
  ...
  // -------------------------------------------------------------------------
  // Validation gates: require sedes and profesores
  // -------------------------------------------------------------------------
          ...
          <Card className="p-8">
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <p className="text-muted-foreground max-w-md">
                Necesitas al menos una sede para crear una convocatoria. Crea una sede primero y
                luego vuelve aqui.
              </p>
              <Button onClick={() => router.push('/sedes/nueva')}>
        ...
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <Card className="p-8">
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <p className="text-muted-foreground max-w-md">
                Necesitas al menos un profesor para crear una convocatoria. Crea un profesor primero
                y luego vuelve aqui.
              </p>
              <Button onClick={() => router.push('/profesores/nuevo')}>
                <Plus className="mr-2 h-4 w-4" />
                Crear Profesor
              </Button>
            </div>
