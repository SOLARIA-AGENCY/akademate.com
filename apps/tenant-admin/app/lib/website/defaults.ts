...
export const CEP_DEFAULT_WEBSITE: WebsiteConfig = {
  ...
  pages: [
    ...
    },
    {
      ...
      pageKind: 'standard',
      seo: {
        title: 'Empleo y Agencia de Colocación | CEP Formación',
        description: 'Bolsa de empleo, orientación laboral y agencia de colocación autorizada de CEP Formación.',
      },
      sections: [],
    },
    {
