...
describe('organization account is N tenants, not N locations', () => {
  ...
  it('does not treat physical or virtual locations as tenant seats', () => {
    ...
    const locations = [
      { id: 'loc-1', tenantId: tenants[0].id, kind: 'physical' as const, name: 'Norte' },
      { id: 'loc-2', tenantId: tenants[0].id, kind: 'physical' as const, name: 'Santa Cruz' },
